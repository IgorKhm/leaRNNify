...
from dfa import load_dfa, random_dfa
...
#     my_list = [0, 1]
#
#     # איבר 1: מספר המילים השונות בקובץ, כלומר לא כולל מילים שחוזרות על עצמן.
#     word_list = words.split(" ")
#     print(word_list)
#     new_list = []
#     for word in word_list:
#         if word not in new_list:
#             new_list.append(word)  # creates empty list
#         print(new_list)
#         my_list[0] = len(new_list)
#         return new_list
#
#     # איבר 2: מילה במיקום שהתקבל כארגומנט לפונקציה
#     if index > len(word_list):
#         index = index - len(word_list)
#     i = index - 1
#     my_list[1] = word_list[i]
#     print(my_list)
#
...
test = model.train_a_lstm(alphabet, target)
...
rvl, _ = confidence_interval(model2, lan, random_word, samples=samples)
svl, _ = confidence_interval(student_pac.dfa, lan, random_word, samples=samples)
...
def make_training_sets(alphabet, target, num_of_exm_per_lenght=200):
    ...
    return test_words[0:int(len(test_words) / 100) * 100], test_label[0:int(len(test_label) / 100) * 100], val_words[
                                                                                                           0:int(
                                                                                                               len(
...
test_words, test_labels, val_words, val_labels, train_words, train_labels = make_training_sets(alphabet, target, 50000)
